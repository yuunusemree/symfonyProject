...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/reservation/{bid}/{osbid}", name="user_reservation_new", methods={"GET","POST"})
     */
    public function newreservation(Request $request, $bid, $osbid, BookRepository $bookRepository, OnShelfBookRepository $onShelfBookRepository): Response
    {
        $book = $bookRepository->findOneBy(['id'=>$bid]);
        $onshelfbook = $onShelfBookRepository->findOneBy(['id'=>$osbid]);
        ...
        if ($form->isSubmitted()) {
            if ($this->isCsrfTokenValid('form-reservation', $submittedToken)) {
                ...
                $reservation->setBookid($bid);
                $reservation->setOnshelfbookid($osbid);
                $user = $this->getUser();
