...
class ImageController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{bid}", name="admin_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request, $bid, Image $image): Response
    {
        ...
        return $this->redirectToRoute('admin_image_new', ['id' => $bid]);
    }
}
